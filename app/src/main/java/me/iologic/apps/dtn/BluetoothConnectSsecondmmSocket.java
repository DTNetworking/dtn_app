...
public class BluetoothConnectSsecondmmSocket extends Thread {
    ...
    public BluetoothConnectSsecondmmSocket(BluetoothAdapter mBluetoothAdapter, Handler getBtConnectionStatus, UUIDManager receivedDeviceUUID) {
        ...
        try {
            ...
            second_tmp = mBluetoothAdapter.listenUsingInsecureRfcommWithServiceRecord(Constants.NAME, receivedDeviceUUID.second_mmSocket_UUID);
        } catch (IOException e) {
