...
public class SecondBluetoothACKBytesT extends Thread {
    ...
    public SecondBluetoothACKBytesT(BluetoothSocket socket, Handler handler) {
        mmACKSocket = socket;
        ...
        while (true) {
            try {
                ...
                if (mmACKInStream.available() > 0) {
                    ...
                    Log.i(Constants.TAG, "Number Of LightningMcQueen Bytes Received (ACK read()): " + numBytes);
